...
var core = {
  ...
  reset: function(){  
    ...
    containers.status.html('بازی شروع شد!');
    containers.time.html('0');
    containers.msg.html('برای شروع بازی روی یکی از خانه ها کلیک کنید');
...
var action = {
  ...
  click: function(e){  
    ...
    if(e.which === 1 && globals.flagMap[x][y] !== 1 && defaults.difficulty !== 0){
      ...
      if(globals.firstClick === true){
        ...
        // Set number of mines
        containers.mines.html('شما باید ' + globals.totalMines + ' مین را پاکسازی کنید تا یرنده شوید!');
  ...
  flag: function(flag, x, y){
    ...
    containers.mines.html('شما باید ' + (globals.totalMines - globals.totalFlags) + ' مین پیدا کنید تا برنده شوید!');
    containers.flags.html('شما  ' + globals.totalFlags + ' پرچم زدید.');
  ...
  won: function(){
    ...
    if(count === globals.totalMines){
      ...
      containers.status.html('شما بردید!');
  ...
  revealMines: function(mine){
    ...
    // Set game over status
    globals.gameover = true;
    containers.status.html('شما باختید');
    containers.msg.html('بر روی شروع مجدد کلیک کنید تا بازی جدیدی را شروع کنید');
...
var scores = {
  ...
  display: function(){
    ...
    if(typeof Storage !== 'undefined'){
      ...
      if(typeof localStorage.scores !== 'undefined'){
        ...
        containers.scoreboard.html('<tr><th>Name</th><th>مین</th><th>ثانیه</th></tr>');
        ...
        containers.scoreboard.html('<tr><td>شما هنوز هیچ بازی را نبرده اید! :(</td></tr>');
      }
    
    }else{
      containers.scoreboard.html('<tr><td>مرورگر اینترنتی شما قدیمی است!</td></tr>');       
    } 
  ...
  save: function(){
    ...
    if(typeof Storage !== 'undefined'){
      ...
      var name = prompt('رکورد شما ثبت شد. لطفا نام خود را وارد نمایید:','Name'),
